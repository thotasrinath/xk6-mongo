...
function getRecord(id) {
    return {
        "_id": `${id}`,
        "tradeDate": {"$date": `${randomDate(new Date(2000, 0, 1), new Date(2022, 0, 1), 0, 24).toISOString()}`},
        "meta": {
            "globalKey": "23f3fed9"
        },
        "trade": {
            ...
            "party": [
                {
                    "meta": {
                        "externalKey": "party1",
                        "globalKey": "33f59567",
                        "partyTradeDate": {"$date": `${randomDate(new Date(2000, 0, 1), new Date(2022, 0, 1), 0, 24).toISOString()}`}
                    },
                    "partyId": [
                        {
                            "identifier": {
